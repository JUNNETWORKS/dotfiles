...
plugins=(git tmux aws yarn npm node adb celery heroku pep8 autopep8 pip pipenv python pylint rust rust docker docker-compose golang terraform kubectl gcloud rails poetry)
